...
<template>
  <div class="flex shrink-0 items-center gap-2 text-sm font-medium text-slate-600" role="status">
    <span class="size-2 rounded-full" :class="statuses[props.status].indicatorClass" aria-hidden="true" />
