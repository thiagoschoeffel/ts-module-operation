...
export const mockOrders: MockOrder[] = [
  { id: 171, createdAt: '11:18', customer: 'Carlos Mendes', phone: '(11) 96543-2109', channel: 'Telefone', itemCount: 2, status: 'andamento', statusLabel: 'Saiu para entrega', deliveryWindow: '13:00–14:00', total: 'R$ 58,00', dietaryRestriction: true },
  { id: 170, createdAt: '11:12', customer: 'Lucas Martins', phone: '(11) 92109-8765', channel: 'WhatsApp', itemCount: 1, status: 'andamento', statusLabel: 'Saiu para entrega', deliveryWindow: '12:00–13:00', total: 'R$ 29,00' },
  { id: 169, createdAt: '11:08', customer: 'Maria Silva', phone: '(11) 99876-5432', channel: 'WhatsApp', itemCount: 3, status: 'andamento', statusLabel: 'Saiu para entrega', deliveryWindow: '12:00–13:00', total: 'R$ 72,00', dietaryRestriction: true },
  { id: 168, createdAt: '10:58', customer: 'João Souza', phone: '(11) 98765-4321', channel: 'Telefone', itemCount: 2, status: 'concluido', statusLabel: 'Entregue', deliveryWindow: '12:00–13:00', total: 'R$ 54,00' },
  { id: 167, createdAt: '10:46', customer: 'Carlos Mendes', phone: '(11) 96543-2109', channel: 'Telefone', itemCount: 1, status: 'concluido', statusLabel: 'Entregue', deliveryWindow: '11:00–12:00', total: 'R$ 29,00', dietaryRestriction: true },
  { id: 166, createdAt: '10:39', customer: 'Beatriz Rocha', phone: '(11) 95432-1098', channel: 'WhatsApp', itemCount: 2, status: 'concluido', statusLabel: 'Entregue', deliveryWindow: '11:00–12:00', total: 'R$ 49,00' },
  { id: 165, createdAt: '10:31', customer: 'Roberto Alves', phone: '(11) 94321-0987', channel: 'Telefone', itemCount: 3, status: 'concluido', statusLabel: 'Entregue', deliveryWindow: '11:00–12:00', total: 'R$ 68,00', dietaryRestriction: true },
  { id: 164, createdAt: '10:24', customer: 'Lucas Martins', phone: '(11) 92109-8765', channel: 'Balcão', itemCount: 1, status: 'concluido', statusLabel: 'Entregue', deliveryWindow: '13:00–14:00', total: 'R$ 25,00' },
  { id: 163, createdAt: '10:17', customer: 'Beatriz Rocha', phone: '(11) 95432-1098', channel: 'WhatsApp', itemCount: 2, status: 'problema', statusLabel: 'Falha na entrega', deliveryWindow: '13:00–14:00', total: 'R$ 54,00' },
  { id: 162, createdAt: '10:09', customer: 'Maria Silva', phone: '(11) 99876-5432', channel: 'WhatsApp', itemCount: 2, status: 'concluido', statusLabel: 'Entregue', deliveryWindow: '13:00–14:00', total: 'R$ 59,00', dietaryRestriction: true },
  { id: 161, createdAt: '10:02', customer: 'Roberto Alves', phone: '(11) 94321-0987', channel: 'Telefone', itemCount: 2, status: 'problema', statusLabel: 'Falha na entrega', deliveryWindow: '13:00–14:00', total: 'R$ 55,00', dietaryRestriction: true },
  { id: 160, createdAt: '09:54', customer: 'Maria Silva', phone: '(11) 99876-5432', channel: 'WhatsApp', itemCount: 2, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '11:00–12:00', total: 'R$ 59,00', dietaryRestriction: true },
  { id: 159, createdAt: '09:47', customer: 'João Souza', phone: '(11) 98765-4321', channel: 'Telefone', itemCount: 1, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '11:00–12:00', total: 'R$ 29,00' },
  { id: 158, createdAt: '09:39', customer: 'Carlos Mendes', phone: '(11) 96543-2109', channel: 'Telefone', itemCount: 2, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '13:00–14:00', total: 'R$ 58,00', dietaryRestriction: true },
  { id: 157, createdAt: '09:31', customer: 'Beatriz Rocha', phone: '(11) 95432-1098', channel: 'WhatsApp', itemCount: 1, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '13:00–14:00', total: 'R$ 29,00' },
  { id: 156, createdAt: '09:24', customer: 'Roberto Alves', phone: '(11) 94321-0987', channel: 'Telefone', itemCount: 3, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '13:00–14:00', total: 'R$ 72,00', dietaryRestriction: true },
  { id: 155, createdAt: '09:16', customer: 'Lucas Martins', phone: '(11) 92109-8765', channel: 'Balcão', itemCount: 2, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '11:00–12:00', total: 'R$ 49,00' },
  { id: 154, createdAt: '09:08', customer: 'Beatriz Rocha', phone: '(11) 95432-1098', channel: 'WhatsApp', itemCount: 1, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '11:00–12:00', total: 'R$ 29,00' },
  { id: 153, createdAt: '08:59', customer: 'Maria Silva', phone: '(11) 99876-5432', channel: 'WhatsApp', itemCount: 2, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '12:00–13:00', total: 'R$ 59,00', dietaryRestriction: true },
  { id: 152, createdAt: '08:51', customer: 'Carlos Mendes', phone: '(11) 96543-2109', channel: 'Telefone', itemCount: 3, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '12:00–13:00', total: 'R$ 72,00', dietaryRestriction: true },
  { id: 151, createdAt: '08:43', customer: 'Roberto Alves', phone: '(11) 94321-0987', channel: 'Telefone', itemCount: 1, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '12:00–13:00', total: 'R$ 29,00', dietaryRestriction: true },
  { id: 150, createdAt: '08:35', customer: 'Lucas Martins', phone: '(11) 92109-8765', channel: 'Balcão', itemCount: 2, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '13:00–14:00', total: 'R$ 49,00' },
  ...
  { id: 145, createdAt: '10:12', customer: 'Carlos Mendes', phone: '(11) 96543-2109', channel: 'Telefone', itemCount: 2, status: 'revisao', statusLabel: 'Pronto para revisão', deliveryWindow: '13:00–14:00', total: 'R$ 57,00', dietaryRestriction: true },
  ...
  { id: 126, createdAt: '07:36', customer: 'João Souza', phone: '(11) 98765-4321', channel: 'Telefone', itemCount: 2, status: 'andamento', statusLabel: 'Embalado', deliveryWindow: '12:00–13:00', total: 'R$ 54,00' },
