...
export const mockOrders: MockOrder[] = [
  { id: 149, createdAt: '10:48', customer: 'Mariana Costa', phone: '(11) 99123-4501', channel: 'WhatsApp', itemCount: 4, status: 'problema', statusLabel: 'Restrição divergente', deliveryWindow: '11:00–12:00', total: 'R$ 41,00', dietaryRestriction: true },
  { id: 148, createdAt: '10:42', customer: 'Maria Silva', phone: '(11) 99876-5432', channel: 'WhatsApp', itemCount: 2, status: 'revisao', statusLabel: 'Pronto para revisão', deliveryWindow: '11:00–12:00', total: 'R$ 9,00', dietaryRestriction: true },
  ...
  { id: 142, createdAt: '09:48', customer: 'Fernanda Nunes', phone: '(11) 93210-9876', channel: 'WhatsApp', itemCount: 2, status: 'problema', statusLabel: 'Endereço incompleto', deliveryWindow: '13:00–14:00', total: 'R$ 34,00' },
