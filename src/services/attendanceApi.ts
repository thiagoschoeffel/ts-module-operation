...
interface ApiMessage { id: string, externalId: string, direction: 'Inbound' | 'Outbound', origin: 'Customer' | 'Automation' | 'Operator', content: string, platformTimestamp: string, receivedTimestamp: string, processingStatus: 'Received' | 'Processing' | 'Processed' | 'Failed' | 'Ignored' | 'OutcomeUnknown', deliveryStatus: string, failureReason?: string }
